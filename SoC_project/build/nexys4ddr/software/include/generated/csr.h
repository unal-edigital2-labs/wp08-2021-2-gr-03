//--------------------------------------------------------------------------------
// Auto-generated by Migen (ac70301) & LiteX (2a172148) on 2022-02-09 15:30:22
//--------------------------------------------------------------------------------
...
/* servo */
#define CSR_SERVO_BASE (CSR_BASE + 0x4800L)
#define CSR_SERVO_POS_ADDR (CSR_BASE + 0x4800L)
#define CSR_SERVO_POS_SIZE 1
static inline uint32_t servo_pos_read(void) {
	return csr_read_simple(CSR_BASE + 0x4800L);
}
static inline void servo_pos_write(uint32_t v) {
